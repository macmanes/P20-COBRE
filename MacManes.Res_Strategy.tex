...
\noindent \textbf{Aim 1a-1:} Determine the physiologic response to drinking-water deprivation, extreme temperature, and humidity in the desert-adapted rodent \textit{P. eremicus}. \\
...
While the prolonged absence of drinking water is invariably fatal for humans and many other animals, one potentially mitigating effect may be the limitation or acquisition of water via the respiratory system. While pulmonary water retention has not been quantified in humans or in mammalian models, the pulmonary vasculature is ideally positioned to retain water from inspired air. In addition to this, some desert rodents are proposed to have very specialized nasal countercurrent systems that further limit respiratory water loss \cite{Huntley:1984us,Hillenius:1992wd}.    

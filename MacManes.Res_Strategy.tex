...
\begin{quote}
The working hypothesis is that while desert-adapted mice may demonstrate patterns of genome wide expression patterns suggestive of stress (e.g. in heat shock proteins), these responses will largely preserve normal physiology and thus function. 

\end{quote}

\noindent \textbf{SPECIFIC AIM 2:} Given the transition from the obligate intake of fluids as infants, to it’s complete absence later in life, the ontogeny of physiologic water conservation will be elucidated.

...
\begin{itemize}
\item Experimental, conceptual, theoretical, and technical innovation: The proposed project leverages unprecedented control over environmental conditions using an ideally suited novel model organism to understand basic physiology in dehydration resistant organisms.
...
%LastlyIn addition to this, some desert rodents are proposed to have very specialized nasal countercurrent systems that further limit respiratory water loss \citep{Huntley:1984us,Hillenius:1992wd}. \\    

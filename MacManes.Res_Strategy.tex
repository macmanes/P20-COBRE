...
Dehydration, whether caused by exposure to extreme environmental conditions, water deprivation, or by infection (e.g. diarrheal illnesses) represents a significant threat to human life.  While the mechanisms underlying physiological compromise are well characterized {}, some animals possess the ability, much unlike humans, to osmoregulate despite extreme heat and a complete lack of extrinsic water intake {}. Specifically, survival phenotypes in \textit{Dipodomys} has been shown to be related to the unique expression profile of Aquaporin 4 {}, while in another desert adapted rodent \textit{Notomys}, patterns of gene expression seem less important {}. Although the study of dehydration in \textit{Mus} and \textit{Rattus} have yielded important isights into mammalian osmoregulation, the study of desert-adapted rodent seem critical to a more complete understanding of the physiology of dehydration. The proposed work uses an innovative approach to experimentally  \\

Because I effectively integrate genomic data with information regarding physiology and metabolism,

The contribution of the proposed work is expected to be 


While each study has provided important insight, single gene studies of this type are necessarily shortsighted in their purview. In addition to this, none of the previous work has  
